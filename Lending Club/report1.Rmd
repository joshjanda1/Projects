...
Project 3 continues where project 2 left off, which is training and evaluating models. In this project, we will focus on three different algorithms. These algorithms are LASSO regression, Ridge Regression, and Decision Trees.

**1 Dividing Data Into Train and Test Set**

Recall this was done in project two, so this is already complete.

**2) Ridge & Lasso Regressions**
...
**a) Fitting Ridge Regressions and Utilizing Cross-Validation for Model Selection**
...
**b Selecting $\lambda$ Within One Standard Error**
...
**c Displaying Cross-Validation Results**
...
**d Displaying Coefficients by Log(Lambda)**
...
**e Coefficients of Chosen Best $\lambda$**
...
**f Error & Accuracy Rate on Test Data**
...
**g Comparing Results Between All Models**
...
**a Using Cross-Validation to Prune Decision Tree**
...
**d Comparing Results Between Tree & Regression Models**
...
**4 Utilizing Boot-Strapping for Fitting Multiple Trees**
...
**b Average Prediction Error Over 100 Trees**
...
**c Comparing Performance Between Bagged Trees and Single Tree**
...
We have fit numerous models using 10-fold cross-validation on the algorithms of LASSO and Ridge Regression as well as Decision Trees. We have also used bootstrap aggregating on decision trees to average prediction results across numerous trees.

Overall, we have learned that shrinkage methods on our data do not perform as well as regular logistic regression, but do outperform decision tree models. I have also learned the importance of training models using cross-validation in order to reduce bias and obtain results that are consistent.

This wraps up project three, and the use of the single Decision Tree, Ridge, and Lasso regression.